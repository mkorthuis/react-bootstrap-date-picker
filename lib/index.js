...
exports.default = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    calendarDisabled: _propTypes2.default.bool,
  ...
  handleBadInput: function handleBadInput(originalValue) {
    ...
    if (this.props.onChange) {
      this.props.onChange(null, parts.join(this.state.separator));
    }
  },
  ...
  render: function render() {
    ...
    var overlay = !this.props.calendarDisabled && _react2.default.createElement(
      _Overlay2.default, {
        rootClose: true,
    ...
    var container = !this.props.calendarDisabled && _react2.default.createElement('div', {
